  ...
  return createTheme({
    palette: {
      ...
      current: {
        light:
          navType === 'dark'
            ? colors.darkSecondaryLight1
            : colors.secondaryLight1,
        main:
          navType === 'dark'
            ? colors.darkSecondaryMain1
            : colors.secondaryMain1,
        dark:
          navType === 'dark'
            ? colors.darkSecondaryDark1
            : colors.secondaryDark1,
        200:
          navType === 'dark' ? colors.darkSecondary2001 : colors.secondary2001,
        800:
          navType === 'dark' ? colors.darkSecondary8001 : colors.secondary8001,
      },
      error: {
